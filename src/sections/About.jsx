    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          <img
            src="public/images/coding-pov.png"
...
24 years young. Built across startups and enterprises — from scalable web applications to in-house software systems — and founder of my own software venture.
        ...
        <div className="grid-special-color grid-2">
          ...
          >
            <p className="flex items-end text-5xl text-white-200">
              CODE IS CRAFT
            </p>
            <Card
            ...
            <Card
              ...
              image="public/images/logos/csharp-pink.png"
              containerRef={grid2Container}
            />
            <Card
              style={{ rotate: "-45deg", top: "70%", left: "25%" }}
              image="public/images/logos/dotnet-pink.png"
              containerRef={grid2Container}
            />
            <Card
              style={{ rotate: "-45deg", top: "5%", left: "10%" }}
              image="public/images/logos/blazor-pink.png"
              containerRef={grid2Container}
            />
          </div>
        </div>
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I'm based in Calgary, Alberta, Canada, and open to relocationg and/or remote work worldwide 
            </p>
          </div>
